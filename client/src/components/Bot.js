  ...
  render() {
    const theme = {
      ...
      options: [
        ...
        { value: 3, label: 'DONE', trigger: '10' },
      ],
    }, 
    {
        id: '8',
        message: 'Users have the privilege of voting and can only voe once in a poll',
        trigger: '7',
      },
      {
        id: '9',
        message: 'Admins have the privelege of creating polls,closing them and also voting',
        trigger: '7',
      },
      {
        id: '10',
